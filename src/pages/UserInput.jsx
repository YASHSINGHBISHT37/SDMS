...
const UserInput = ({setStockData}) => {
    ...
    return (
        <div className='relative w-sc z-99 space-y-1'>

            <div className='relative mt-8'>
                <div className='relative z-50 backdrop-blur-[vh] bg-white border border-blue-500/40 rounded-2xl h-10 w-[42vh] pl-3 pr-1 text-blue-500 flex items-center space-x-2'>
                    <input
                        ref={inputRef}
                        value={userInput}
                ...
                {suggestions.length > 0 && (
                    <ul className='Suggestions bg-[#161616]/40 backdrop-blur-[.6vh] bg absolute w-full max-h-54 top-0 border border-blue-500/30 rounded-2xl overflow-auto'>
