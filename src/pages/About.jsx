...
const About = () => {
    ...
    if (!stockData) return <p className='bg-amber-00 z-999999'>Loading stock data...</p>
    ...
    return (
        <div className='relative z-50 w-full h-auto mt-4 mb-12 border border-white/20 rounded-3xl p-3 pb-1 pt-6 bg-[#161616]/30 backdrop-blur-2xl'>
