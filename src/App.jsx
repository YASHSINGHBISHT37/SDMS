...
import { Data, useStockData } from './pages/Data'
  ...
  return (
    <Data>
      <div className='bg-[#161616] w-screen min-h-screen h-auto py-3 select-none flex flex-col justify-center items-center pt-12'>
        ...
        <div className='bg-[#161616] w-screen h-full fixed top-0 left-0 pt-12 p-3 flex justify-center items-center flex-col overflow-auto pointer-events-none z-[1]'>
